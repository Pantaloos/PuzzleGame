...
class Board(size: Int) {
    ...
    private fun  swapTiles(){
        val p1 : Place? = at(randoms.nextInt(size)+1, randoms.nextInt(size)+1)
        val p2 : Place? = at(randoms.nextInt(size)+1, randoms.nextInt(size)+1)
    ...
    companion object{
        private val randoms:Random = Random
    }
